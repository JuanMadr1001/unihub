...
import { Plus, LogOut, Leaf, Sun, Moon, X } from "lucide-react"
...
export default function Sidebar({ activeGroup, onSelectGroup, user, open, onClose }) {
  ...
  return (
    <>
      ...
      <div className={`
        ...
        w-56 min-w-56 h-full flex flex-col
      ...
      `}>
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center gap-3">
          ...
          <button
            onClick={onClose}
            className="md:hidden text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 p-1 rounded-lg"
          >
            <X size={16} />
          </button>
        </div>
